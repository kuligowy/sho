...
public class ShopControllerTest {
	...
	public void setup() throws Exception {
		...
		// this.receipt = this.shopRepository.save(new Shop(1, "Biedronka",
		// 10));
		Shop shop = new Shop(1, "Biedronka", 10);
		this.receipt = new Receipt();
		this.receipt.setShopId(shop);
		this.receipt.setEventTime(new Date());
